...
photologo = 'https://graph.org/file/227e5d14667b8a290802a-4471fef9116bbbe39f.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://graph.org/file/227e5d14667b8a290802a-4471fef9116bbbe39f.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://graph.org/file/227e5d14667b8a290802a-4471fef9116bbbe39f.jpg'
photozip = 'https://envs.sh/cD_.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/+b3WJQhx86sAwZDA9")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+b3WJQhx86sAwZDA9l"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/+b3WJQhx86sAwZDA9"),
        ],
    ]
)
...
image_urls = [
    "https://graph.org/file/227e5d14667b8a290802a-4471fef9116bbbe39f.jpg",
    "https://graph.org/file/227e5d14667b8a290802a-4471fef9116bbbe39f.jpg",
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [𝗦𝗔𝗠𝗨𝗥𝗔𝗜](https://t.me/+b3WJQhx86sAwZDA9)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
...
async def txt_handler(bot: Client, m: Message):  
    ...
    try:
        response = requests.get(raw_text6, timeout=10)
        response.raise_for_status()  # Check if URL is valid
         with open("/tmp/thumb.jpg", "wb") as f:  # use /tmp for Render
